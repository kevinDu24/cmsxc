 ...
 * @date 2017/10/30
 */
public enum ResponseFailEnum implements ResponseType{
    ...
    SINGLE_LOGIN_ERROR("95000000","single_login_error","单点登录异常"),
    LEASE_PUSH_ERROR("5555555","lease_push_error","委托公司推送异常") //收车公司已存在、已经取消不可取消等提示停止定时任务的code
    ;


    ResponseFailEnum(String code, String mark, String message) {
        this.code = code;
