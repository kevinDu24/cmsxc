...
import cn.com.leadu.cmsxc.oauth2.service.SysClientService;
...
public class CmsAuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
...
//        defaultTokenServices.setAccessTokenValiditySeconds(tokenConstant.getTokenTimeSecondsAccess() * 60);
//        defaultTokenServices.setRefreshTokenValiditySeconds(tokenConstant.getTokenTimeSecondsRefresh() * 60);
