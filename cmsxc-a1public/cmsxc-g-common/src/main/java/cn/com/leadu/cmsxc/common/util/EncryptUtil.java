...
public class EncryptUtil {
    ...
    public static EncryptUtil des = null;

    static {
        try{
            des = new EncryptUtil("leadu", "utf-8");
        }catch (Exception ex){
            ex.printStackTrace();
        }
    }
    ...
    public static String encodeStr(String data) throws Exception{
        return EncryptUtil.des.encode(data);
    }

    public static String decodeStr(String data) throws Exception {
        return EncryptUtil.des.decode(EncryptUtil.des.encode(data));
    }
