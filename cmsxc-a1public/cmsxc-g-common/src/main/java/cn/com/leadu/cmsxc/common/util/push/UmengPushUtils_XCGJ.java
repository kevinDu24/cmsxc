 ...
 */
public class UmengPushUtils_XCGJ {
    ...
    public UmengPushUtils_XCGJ(String key, String secret) {
        try {
            appkey = key;
    ...
    public static int push(String messageType, String clientType, String deviceToken,
        ...
        UmengPushUtils_XCGJ umengPushUtils;
        //推送给ios设备
        if(ClientTypeEnums.IOS.getCode().equals(clientType)){
            umengPushUtils = new UmengPushUtils_XCGJ("5b232938f43e48377d000095", "kfocntsy2zuzsv2itjb2piffuf6l4nxo");
            //单播
            ...
            umengPushUtils = new UmengPushUtils_XCGJ("5b23287ef43e4823f6000090", "ezvqd94i65gwuffogj5mgwpurb2ria80");
            //单播
            if(PushCastEnum.UNICAST.getCode().equals(messageType)){
